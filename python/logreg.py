...
# coursera. It is part of the first course (week 2)
#
# Code is taken from the Notebook.
#
# Missing the images that exist in the Coursera's environment.
# Need to download the cat images and then write a new
# version of the load_data() function.
#
...
# 3 - General Architecture of rhe learning algorithm
# ==================================================
...
def predict(w, b, X):
    ...
    # (≈ 1 line of code)
    # The solution avoids the need for a for loop, so that has been removed.
